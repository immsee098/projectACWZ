...
<header id="header">
	<div class="fix-layout">
		...
		<!-- <div id = "no_design_gnb" style="text-align:center"> -->

		<!-- manager.css.php #header부분 좌측 레이아웃임 -->
  <div id= "gnb"> 
    <div id = "yes_design_gnb">
			<ul style="text-align:center">
        <li class= "navi-icon">
          <a href="#">공지사항</a>
        </li>
        <li class= "navi-icon">
          <a href="<?=G5_URL?>/member">멤버란</a>
        </li>
        <li class= "navi-icon">
          <a href= "http://arcanawizard.ivyro.net/bbs/content.php?co_id=member_1">중등부</a>
        </li>
      </ul>
			<? include(G5_PATH."/templete/txt.bgm.php"); ?>
		</div>
