	...
	<div id="no_design_main">
		...
		<div id="main_side_box">
			...
			<div id="main_banner_box" class="theme-box">
				...
				<p> qna / 정산 게시판 / 알바 게시판</p>
				<!-- <a><a href="http://bytheallspark.cafe24.com/" target="_blank">http://bytheallspark.cafe24.com/</a></p> -->
			</div>
		</div>

		<div id="main_copyright_box" class="theme-box txt-center">
			COPYRIGHT &copy; 2017 by Arcana Wizard Academy
		</div>
