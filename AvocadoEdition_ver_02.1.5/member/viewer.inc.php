...
<!-- // 캐릭터 기본정보 출력 영역 -->
	...
	<!-- <button class= "custom-grade" style= "background:blue; border:none">중등부</button>
	<button class= "custom-grade">고등부</button>
	<button class= "custom-grade">성인</button> -->
<!-- //학년 설정-->
...
<? if($article['ad_use_closet'] && $article['ad_use_body'] && $mb['mb_id'] == $member['mb_id']) { 
	...
	// -- 옷장 출력형태 변경을 원할 시, mypage/character/cloest.inc.php 파일을 수정해 주시길 바랍니다.
?>
	<hr class="padding" />
	<h3>CLOSET</h3>
	<div class="theme-box">
